...
public class View extends JFrame {
	...
	public void paint(Graphics g) {
    	...
    	this.createBin(bufferGraphics, x-300, 400+y, 1, model.bins[0]);
    	this.createBin(bufferGraphics, x-100, 400+y, 2, model.bins[1]);
	...
	public void createStage(Graphics2D g2, int x, int y, int d, Stage s) {
    ...
    public void createChute(Graphics2D g2, int x, int y, int d, String color, int parcel) {
    ...
    public void createBin(Graphics2D g2, int x, int y, int number, int parcel) {
    	g2.setStroke(new BasicStroke(10, BasicStroke.JOIN_ROUND, BasicStroke.CAP_ROUND));
    ...
    public void createSwitcher(Graphics2D g2, int x, int y, int d, int door, String color, int parcel) {
    	...
    	if (parcel > 0) {
    		...
    		g2.setFont(new Font("Arial", Font.PLAIN, 20));
    		g2.setColor(Color.black);
    		long xt = Math.round(35-door*50+x+10);
        	g2.drawString(String.valueOf(parcel), xt, 60+y);
    	}
    }
